...
model_without_grad = make_model("subset")["background"]["photometric"]
...
figure_path = paths.scripts / "gd1" / "_diagnostics" / "subset" / "phot_flow"
...
if snkmk["save_to_static"]:
    xp.save(
        model.state_dict(),
        paths.static / "gd1" / "subset" / "background_photometry_model.pt",
    )
