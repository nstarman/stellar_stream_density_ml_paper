...
x1 = pm_edges["pm_phi1_cosphi2_tight"][:split].value
y1 = pm_edges["pm_phi2_tight"][:split].value
x2 = pm_edges["pm_phi1_cosphi2_tight"][split:].value
y2 = pm_edges["pm_phi2_tight"][split:].value
...
ax00.plot(x1, y1, c="tab:blue", lw=1, zorder=-5)
ax00.plot(x2, y2, c="tab:blue", lw=1, zorder=-5)
