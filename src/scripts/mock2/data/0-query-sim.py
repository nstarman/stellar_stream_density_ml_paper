...
if snkmk["load_from_static"]:
    shutil.copyfile(
        paths.static / "mock2" / "gd1_query_sim.fits",
        paths.data / "mock2" / "gd1_query_sim.fits",
    )

    result = QTable.read(paths.data / "mock2" / "gd1_query_sim.fits")
    ...
    FROM gaiadr3.gaia_source_simulation as gaia
    WHERE
    ...
    # Run the query
    # result = do_query(query_sim, paths.data / "mock2" / "gd1_query_sim.fits")
    saveloc = paths.data / "mock2" / "gd1_query_sim.fits"
...
if snkmk["diagnostic_plots"]:
    ...
    fig.tight_layout()
    fig.savefig(diagnostic_plots / "sim_data_distributions.png")
    ...
    fig.tight_layout()
    fig.savefig(diagnostic_plots / "sim_distance_dependence.png")
