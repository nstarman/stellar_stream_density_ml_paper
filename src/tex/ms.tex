...
\section{Method} \label{sec:method}
    ...
    \subsection{Photometric Model} \label{sub:photometric_model}
        ...
        \subsubsection{On-Stream} \label{sub:photometric_model_on_stream}
            ...
            The second term in \autoref{eq:isochrone_prior_components} -- $\prior_{obs}(\nth{\mbs{m}} | \phi_1)$ -- encodes all observational effects in the photometric dataset. Some effects are easily modeled, e.g. datasets have magnitude limits, both faint and bright. Other effects are not, e.g, complex location-dependent completeness issues.
            Accounting for the latter is very challenging.

            \citep{GaiaCompleteness}
            ...
            \todo[inline]{I don't think this is necessary}
