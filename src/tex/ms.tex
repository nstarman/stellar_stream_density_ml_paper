...
\section{Method} \label{sec:method}
    ...
    \subsection{Missing Phase-Space Observations} \label{sub:method:missing_data}
        ...
        \citep[e.g.,][]{Koposov2019, Antoja2020, 2022ApJ...928...30L},
...
\section{Results: GD-1} \label{sec:results_gd1}
    ...
    \subsection{Data Selection} \label{sub:results_gd1:data}
        ...
        each star, and \PanStarrs{} to obtain more accurate color information.
        
        We cross-match the \Gaia{} field on \PanStarrs{} using the provided
        \texttt{Best-neighbors} catalog.
        ...
        We use the \texttt{GD1Koposov10} frame defined in Gala \TODO{[cite gala and Koposov10]}
