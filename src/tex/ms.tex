...
\section{Results: GD-1} \label{sec:results_gd1}
    ...
    \subsection{Model Specification}\label{sub:results_gd1:model}
        ...
        the model built for the mock stream in \autoref{sec:results_mock:model},
        ...
        fixed when incorporated into the larger model.

        One part of the larger model is the astrometric component of the background.
        Unlike for the photometry, the background may be fit with simple analytic
        distributions. We use an exponential distribution (see \autoref{sub:exponential_distribution})
