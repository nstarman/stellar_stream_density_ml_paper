...
\section{Results: Mock} \label{sec:results_mock}
    ...
    The synthetic stream's photometry is also simulated using a \variable{output/mock/isochrone_age_variable.txt},
    [Fe/H] = \variable{output/mock/isochrone_feh_variable.txt} MIST isochrone \TODO{[cite brutus]}. The isochrone is truncated just
    ...
    we proceed to train the full model.
