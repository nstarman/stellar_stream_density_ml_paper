...
\section{Method} \label{sec:method}
    ...
    \subsection{Likelihood Setup}\label{sub:method:likelihood_setup}
        ...
        % \end{figure}
        \begin{figure}
            \script{gd1/plot/pgm_stream.py}
            \centering
            \includegraphics[scale=0.5]{figures/gd1/pgm_stream.pdf}
            \caption{Probabilistic Graphical Model of the Mixture Density Network (MDN)}
            \label{fig:PGM_stream}
        \end{figure}

        \begin{figure}
            \script{gd1/plot/pgm_background.py}
            \centering
            \includegraphics[scale=0.5]{figures/gd1/pgm_background.pdf}
...
\section{Results: GD-1} \label{sec:results_gd1}
    ...
    \subsection{Model Specification}\label{sub:results_gd1:model}
        ...
        % TODO: make this dynamically generated from the actual data.
        \begin{table}
            \centering
...
\section{Palomar 5} \label{sec:results_pal5}
    ...
    \subsection{Trained Density Model} \label{sub:results_pal5:results}
        ...
        \begin{figure*}[h]
            ...
            \centering
            \includegraphics[width=1\linewidth]{figures/pal5/results_full.pdf}
            \caption{CAPTION}
        ...
        \begin{figure*}
            ...
            \centering
            \includegraphics[scale=0.8]{figures/pal5/smooth_likelihood.pdf}
            \caption{Caption}
