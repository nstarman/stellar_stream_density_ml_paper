...
\section{Method} \label{sec:method}
    ...
    \subsection{Priors} \label{sub:priors}
        ...
        \subsubsection{Parameter Bounds}
            ...
            Hard cutoffs can be an unwise choice of prior, but we set the ranges to larger than the data prefers and check that the parameters are never ``up against" the bound
