...
\section{Method} \label{sec:method}
    ...
    \subsection{Priors} \label{sub:priors}
        ...
        \subsubsection{Parameter Bounds}
            ...
            produce outputs outside the hard bounds. This is a standard technique in ML to ensure that the nerual network is efficient, only covering the required region of the output space 
