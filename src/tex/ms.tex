...
\section{Results: Mock} \label{sec:results_mock}
    ...
    photometric coordinates, with $\variable{output/mock/ncorrect_variable}\%$ stream
    stars being recovered with membership probability greater than $80\%$. The false
    positive rate (i.e., stars misidentified as stream members) for this test is
    found to be $\variable{output/mock/falseident_variable.txt}\%$ when cutting on
    this threshold. 
